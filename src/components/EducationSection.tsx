...
const education = [
  { degree: "M.Sc. Computer Science", school: "MIT", year: "2018", desc: "Specialized in AI & Machine Learning", icon: GraduationCap },
  { degree: "B.Sc. Software Engineering", school: "Stanford University", year: "2016", desc: "Dean's List, GPA 3.9", icon: Award },
];
